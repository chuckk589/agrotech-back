...
(1,	1,	'0.4.11',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для получения базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image.PNG',	'WIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(2,	1,	'0.4.12',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image_qHIHiN2.PNG',	'LIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(3,	2,	'0.4.13',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для получения базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image.PNG',	'WIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(4,	2,	'0.4.14',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image_qHIHiN2.PNG',	'LIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(5,	3,	'0.4.15',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для получения базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image.PNG',	'WIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(6,	3,	'0.4.16',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image_qHIHiN2.PNG',	'LIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(7,	4,	'0.4.17',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для получения базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image.PNG',	'WIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11'),
(8,	4,	'0.4.18',	'https://disk.yandex.ru/d/oama_mdIY3Ig_Q',	'Версия симулятора EduTechSim от компании Прикладная робототехника. Предназначена для базовых навыков пилотирования и обслуживания БПЛА различных типов и размеров',	'images/image_qHIHiN2.PNG',	'LIN',	NULL,	3,	'Операционная система: Windows 10 (64-bit);Процессор: Intel Core i5-4460 или AMD FX-6300;Оперативная память: 8 ГБ RAM;Видеокарта: NVIDIA GeForce GTX 960 или AMD Radeon R7 260X с 2 ГБ видеопамяти;Место на диске: 50 ГБ (зависит от игры);DirectX: Версия 11');
